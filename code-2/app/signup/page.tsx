    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        <Link href="/" className="flex items-center justify-center gap-2 mb-8 group">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary via-secondary to-accent group-hover:scale-110 transition-transform duration-300">
        ...
        <Card className="glass-effect border-border/50 shadow-xl">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Join our community and start trading skills today</CardDescription>
          </CardHeader>
          <CardContent>
